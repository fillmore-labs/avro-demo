...
public final class SpecificSchemaHelper {
  ...
  private static SpecificRecord createSampleRecord(int index) {
    return switch (index) {
      case 1 -> AvroRecord1.newBuilder().setField1("content1").build();
      case 2 -> AvroRecord2.newBuilder().build();
      case 3 -> AvroRecord3.newBuilder().setField1("content1").build();
      case 4 -> AvroRecord4.newBuilder().build();
      case 5 -> AvroRecord5.newBuilder().setField2(null).build();
      case 6 -> AvroRecord6.newBuilder().build();
      case 7 -> AvroRecord7.newBuilder().setField2(null).build();
      case 8 -> AvroRecord8.newBuilder().setField2(null).build();
      case 9 -> AvroRecord9.newBuilder().setField2(null).build();
